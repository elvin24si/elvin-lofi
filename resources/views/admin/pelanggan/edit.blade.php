                                ...
                                <div class="col-lg-6 col-sm-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $dataPelanggan->first_name }}" placeholder="Enter first name"
                                            required>
                                        @error('first_name')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            id="last_name" name="last_name" value="{{ $dataPelanggan->last_name }}"
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="phone" value="{{ $dataPelanggan->phone }}"
